...
cat > $PCKDIR/usr/sbin/mkinitramfs << "EOF"
#!/bin/bash
...
install -m0755 $INITFILE $WDIR/init
...
chmod 0755 $PCKDIR/usr/sbin/mkinitramfs


mkdir -p $PCKDIR/usr/share/mkinitramfs

cat > $PCKDIR/usr/share/mkinitramfs/init.in << "EOF"
#!/bin/sh
